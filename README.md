...
- 使用 **Streamlit Web Demo** 展示完整用户旅程，适合面试、客户沟通和 PoC 演示。
...
| 文件 | 模块作用 | 在售前演示中的价值 |
|---|---|---|
| `app.py` | Streamlit 网页入口，支持登录、聊天、侧栏用户档案、图片上传和复盘展示 | 用于客户现场或面试中演示完整用户旅程，让非技术角色直观看到方案效果 |
...
这个项目可以证明以下 AI 售前 / 解决方案顾问 / Presales Engineer 能力：
...
- [售前一页纸](docs/presales-one-pager.md)
- [5-8 分钟 Demo 讲解脚本](docs/demo-script.md)
- [简历项目描述 Bullet Points](docs/resume-bullets.md)
